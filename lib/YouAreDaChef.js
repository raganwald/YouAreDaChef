  ...
  _.defaults(this, {
    YouAreDaChef: function() {
            ...
            if (!(clazz.prototype.hasOwnProperty(name) && (daemonology["default"] != null))) {
              ...
              clazz.prototype[name] = function() {
                ...
                if (clazz.prototype["guard_" + name + "_daemon"].apply(this, args)) {
                  ...
                  return _.tap((_ref3 = clazz.prototype["around_" + name + "_daemon"]).call.apply(_ref3, [this, daemonology["default"][1]].concat(__slice.call(args))), function(retv) {
      ...
      return combinator = _.tap({
        ...
        return _.each(['default', 'before', 'around', 'after', 'guard'], function(verb) {
          return c[verb] = function() {
            var advice, args, expr, pointcut_exprs, _i, _ref, _results;
            args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            if (args.length === 1) {
              _ref = args[0];
              _results = [];
              for (expr in _ref) {
                ...
                advice = _ref[expr];
                _results.push(advise(verb, advice, this._namespace, [expr]));
              }
              return _results;
              ...
              return advise(verb, advice, this._namespace, pointcut_exprs);
            } else {
