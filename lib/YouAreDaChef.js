(function() {
    ...
    Combinator.prototype["for"] = function() {
      ...
      if (args.length > 0 && _.all(args, _.isFunction)) {
        ...
        if (_.isArray(clazz_arg)) {
          ...
          throw "What do I do with { " + (this.namespace()) + ": " + " }?";
        }
      }
      return this;
    };

    Combinator.prototype.advise = function(verb, advice, namespace, pointcut_exprs) {
      if (!this.clazzes().length) throw "Need to define one or more classes";
      return _.each(this.clazzes(), function(clazz) {
        var daemonize, expr;
    ...
    return Combinator.prototype[verb] = function() {
      ...
      if (args.length === 1) {
        ...
        for (expr in _ref) {
          ...
          advice = _ref[expr];
          this.advise(verb, advice, this.namespace(), [expr]);
        }
        ...
        this.advise(verb, advice, this.namespace(), pointcut_exprs);
      } else {
  ...
  _.each(['for', 'namespace', 'clazzes', 'tag'], function(definition_method_name) {
